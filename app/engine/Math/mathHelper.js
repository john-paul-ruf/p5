...
MathHelper.multMatrixVector = (m, v) => {
...
MathHelper.projectWorldToCanvas = (canvas, vWorld) => {
...
MathHelper.projectCanvasToWorld = (canvas, vCanvas) => {
  ...
  var vWorld = MathHelper.multMatrixVector(invMVP, vNDC);
